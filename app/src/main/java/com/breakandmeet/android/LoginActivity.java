...
public class LoginActivity extends AppCompatActivity {
    ...
    Button _loginButton;
    @InjectView(R.id.btn_logFB)
    Button _loginFButton;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        _loginFButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                login();
            }
...
/*        if (email.isEmpty() || !android.util.Patterns.EMAIL_ADDRESS.matcher(email).matches()) {
    ...
    public void loginAPI (Context context, final String mail, final String password) {
       ...
       /* ApiService apiService = ServiceGenerator.createService(ApiService.class, "auth-token");
        Call<User> call = apiService.auth();
